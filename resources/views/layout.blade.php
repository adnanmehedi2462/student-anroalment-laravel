  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin_dashbord')}}"><img src="images/salt_logo.svg" alt="Logo"></a>
      </div>
        ...
        <ul class="navbar-nav ml-lg-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              ...
              <a class="dropdown-item" href="{{URL::to('/satting')}}">
                <div class="sender-img">
                  <img src="http://via.placeholder.com/47x47" alt="">
                  <span class="badge badge-primary">&nbsp;</span>
                </div>
                <div class="sender">
                  <p class="Sende-name">Satting</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/allteacher')}}">View teacher</a>
                  </li>
