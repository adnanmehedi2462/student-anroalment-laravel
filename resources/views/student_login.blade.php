...
<head>
  ...
  <link rel="stylesheet" href="{{asset('stu/node_modules/font-awesome/css/font-awesome.min.css')}}" />
        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3">Login  student</h3>
              ...
              <form action="{{url('/studentlogin')}}" method="post">
               {{csrf_field()}}
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control p_input" name="student_pass">
                </div>
